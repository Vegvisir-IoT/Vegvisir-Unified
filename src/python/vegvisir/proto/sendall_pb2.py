...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\rsendall.proto\x12\x0evegvisir.proto\x1a\x14vegvisirCommon.proto\"8\n\x0eSendallMessage\x12&\n\x03\x61\x64\x64\x18\x02 \x01(\x0b\x32\x19.vegvisir.proto.AddBlocksb\x06proto3')
  ,
...
_SENDALLMESSAGE = _descriptor.Descriptor(
  name='SendallMessage',
  full_name='vegvisir.proto.SendallMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='add', full_name='vegvisir.proto.SendallMessage.add', index=0,
...
SendallMessage = _reflection.GeneratedProtocolMessageType('SendallMessage', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:vegvisir.proto.SendallMessage)
  ))
