...
_VECTORCLOCK_CLOCKSENTRY = _descriptor.Descriptor(
  name='ClocksEntry',
  full_name='VectorClock.ClocksEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='VectorClock.ClocksEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='VectorClock.ClocksEntry.value', index=1,
...
_VECTORCLOCK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='clocks', full_name='VectorClock.clocks', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sendLimit', full_name='VectorClock.sendLimit', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='VectorClock.signature', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='publicKey', full_name='VectorClock.publicKey', index=3,
...
_VECTORMESSAGE = _descriptor.Descriptor(
  name='VectorMessage',
  full_name='VectorMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='worldView', full_name='VectorMessage.worldView', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='add', full_name='VectorMessage.add', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='vector_message_type', full_name='VectorMessage.vector_message_type',
...
VectorClock = _reflection.GeneratedProtocolMessageType('VectorClock', (_message.Message,), dict(
  ...
  ClocksEntry = _reflection.GeneratedProtocolMessageType('ClocksEntry', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:VectorClock.ClocksEntry)
    ))
  ,
